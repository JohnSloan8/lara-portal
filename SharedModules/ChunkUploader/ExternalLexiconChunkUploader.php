...
<?php
    ...
    $drp_Language = Language::LanguageDropBox("LanguageID", true);
    $drp_Language_mwe = Language::LanguageDropBox("MweLanguageID", true);
...
<div class="importLaraContent" id="importLaraContentDiv">
    ...
    <div class="table">
        <input type="hidden" id="UploadType" name="UploadType" value="Lexicon">
        <div class="tr">
            <div class="tdTXT">
                <input type="radio" id="UploadType_resource" name="UploadTypeOptions"  value="Resource" >Upload resource for <?php echo $drp_Language; ?>
            </div>
        </div>
        <div class="tr">
            <div class="tdTXT">
                <input type="radio" id="UploadType_MWE" name="UploadTypeOptions"  value="MWE" >Upload MWE definition for <?php echo $drp_Language_mwe; ?>
            </div>
        </div>
        <div class="tr">
            <div class="tdTXT">
