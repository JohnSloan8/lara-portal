...
class Content
{
    ...
    public $LangRepType;
    public $WordsAudioType;
    public $SegmentsAudioType;
    public $TtsEngine;
    public $TtsVoice;
    public $WordAudio;
    public $SegmentAudio;
    ...
    public $HasTtsSubstitution;
    public $TtsSubstitutionFileName;
    ...
    static function ContentChildrenList($contenID)
    {
        $query = "select ContentID , DirName from Contents where IsDeleted = 'NO' and ParentID = :pID";
        $whereParam = array(":pID" => $contenID);
        $temp = PdoDataAccess::runquery($query, $whereParam);
        return $temp;
    }

    static function hasTakenChildren($whereParam = array())
    {
        $query = "select CrowdworkerID from Contents where ParentID = :pID";
        $temp = PdoDataAccess::runquery($query, $whereParam);
