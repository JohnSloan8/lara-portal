...
//    echo("Read mwe annotation json: " . $time_elapsed_secs . "----");
//    $start = microtime(true);
...
//    $time_elapsed_secs = microtime(true) - $start;
//    echo("Convert nwe Python jsons to PHP jsons: " . $time_elapsed_secs . "----");
//    $start = microtime(true);
...
//    $time_elapsed_secs = microtime(true) - $start;
//    echo("Convert PHP mwe jsons to CSV using python: " . $time_elapsed_secs . "----");
//    $start = microtime(true);
...
//    $time_elapsed_secs = microtime(true) - $start;
//    echo("Convert PHP mwe index to CSV using python: " . $time_elapsed_secs . "----");
//    $start = microtime(true);
...
//    $time_elapsed_secs = microtime(true) - $start;
//    echo("Convert PHP mwe chunk jsons to CSV using python: " . $time_elapsed_secs . "----");
//    $start = microtime(true);
...
//    $time_elapsed_secs = microtime(true) - $start;
//    echo("Put mwe csv in db: " . $time_elapsed_secs . "----");
//    $start = microtime(true);
...
//    $time_elapsed_secs = microtime(true) - $start;
//    echo("Put mwe index csv in db: " . $time_elapsed_secs . "----");
//    $start = microtime(true);
...
//    $time_elapsed_secs = microtime(true) - $start;
//    echo("Put mwe chunk csv in db: " . $time_elapsed_secs . "----");
    return true;
}
