...
$drp_RH = ReadingHistory::ReadingDropBox("ReadingHistoryID", $_SESSION[SessionIndex['UserID']]);
...
<div class="logData" id="logDataDiv">
    ...
    <form method="POST" id="readingLogForm" enctype='multipart/form-data'>
        <input type="hidden" id="task" name="task" value="GetReadingHistoryLog">
        ...
        <div class="table">
            ...
            <div class="tr">
                <div class="tdHalf">
                    <div class="tdTitle">Reading History:</div>
                    <div class="tdInput">
                        <?php echo $drp_RH; ?>
                    </div>
                </div>
                <div class="tdHalf">
                    ...
                    <div class="tdInput">
                        <input type="button" value="show logs" id="SearchButt" name="SearchButt" onclick="searchReadingLog()">
                    </div>
                </div>
            </div>
        </div>

        <div id="HistoryLogsDataDiv">
        </div>
