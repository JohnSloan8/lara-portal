...
<div class="LaraContents">
    <table id="TableOfFlashcardContents" class="display" style="width:100%">
        ...
        <tr>
            ...
            <th>Read text</th>
            <th>Take a new test</th>
            <th>Repeat last test</th>
            <th>Repeat and improve</th>
        ...
        <?php
            for($i = 0; $i < count($info); $i++)
            {
                ...
                $trString .= "<td style='text-align: center'>
                               <img src='../img/flashcard-repeat.png' title='Repeat the last flashcard test' 
                               onclick='repeatLastTest(\"" . $info[$i]["ContentID"] . "\"," .
                                                       "\"" . $_SESSION[SessionIndex['UserID']]. "\");' ></td>";

                $trString .= "<td style='text-align: center'>
                               <img src='../img/first-aid-icon.png' title='Start flashcard test' 
                               onclick='beforeGenerateFlashcardSet(\"" . $info[$i]["ContentID"] . "\"," .
                                                                "\"" . $_SESSION[SessionIndex['UserID']] . "\"," .
                                                                "\"" . $info[$i]["WordTranslationFC"] . "\"," .
                                                                "\"" . $info[$i]["AudioTranslationFC"] . "\"," .
